  ...
  return (
    ...
    >
      ...
      <div className={cn(styles.bar, "flex items-center justify-between")}>
        <Link href="/" className={cn("flex items-center justify-center", styles.logo)}>
        ...
        <div className="flex items-center">
          ...
          {mounted && isHome && process.env.NEXT_PUBLIC_WS_URL && <OnlineUsers />}
          {mounted && config.githubUsername && config.githubRepo && (
            <GitHubStarsButton
          ...
          <Link href="/tic-tac-toe" title="Play XO Arena">
            <Button
              variant="ghost"
              className={cn(
